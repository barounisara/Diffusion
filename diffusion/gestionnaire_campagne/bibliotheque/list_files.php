        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <!--/.content-->
                       <div class="span4">
                        ...
                        Liste de lecture   
                        <button id="save" class="btn btn-small btn-success pull-right">
                            <span class="icon-save">
                            </span>
                        </button>
                        <button class="btn btn-info pull-right" style="display:none;" name="save_playlist" id="save_playlist">
                            <span class="icon-ok"></span>
                        </button>
                    </div>
              
                        <form  id="add_div" class="form-horizontal" action="" method="post">

                        <input type="hidden" name="filelist" id="filelist" value=""/>
                        </form>
                    
                    <div class="content"> 
                    <div  class="module" id='draggable'>
                ...
                <div class="span5">
                        ...
                        <div class="content"> <div  class="module">
