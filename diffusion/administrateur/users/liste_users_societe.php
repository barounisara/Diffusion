...
function liste_utilisateurs()
{
		...
		$societe=$row['societe'];
		$query="SELECT login from utilisateur WHERE societe='$societe'";
		$select=$conn->query($query);
		$i=0;
						...
						<div  id="add_div"></div>
                            ...
                            <div class="module-option clearfix">
                                ...
                                <div class="btn-group pull-right" data-toggle="buttons-radio">
                                    <button type="button" onclick="ajouter_user()" class="btn btn-large btn-primary">
                                        <i class="icon-user"></i>Créer un utilisateur</button>
                                </div><br><br>
