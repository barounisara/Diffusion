(function(a) {
    window.elFinder = function(b, c) {
            ...
            lang: "en",
            cssClass: "",
            commands: ["open","addtoplaylist", "reload", "home", "up", "back", "forward", "getfile", "quicklook", "download", "rm", "duplicate", "rename", "mkdir", "mkfile", "upload", "copy", "cut", "paste", "edit", "extract", "archive", "search", "info", "view", "resize", "sort"],
            commandsOptions: {
                getfile: {
                    onlyURL: !0,
                    multiple: !1,
