          ...
          <div >
            <form action="" method="post" id="add_div">
                 <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                                                ...
                                                <li><a href="#blue" data-toggle="tab">Mesure d'audience</a></li>
                                            </ul>
                    ...
                    <div id='draggable'>
                                    ...
                                    <tbody id="addtbody">
                                        ...
                                        <div class="tab-pane" id="blue">
                                                 <label class="radio"> <a href='list_files_audience.php' class="a-none"> 
                                                    Avec mesure d'audience
                                                    <input type="radio" name="separation-sexuee" id="separation-sexuee" value="0"></a>

                                                </label>
                                                
                                                <label class="radio">
                                                    Sans mesure d'audience
                                                    <input type="radio" name="separation-sexuee" id="separation-sexuee" value="1">
                                                </label>
                                        </div>
                                    </div>
                ...
                <button id="save_playlist" class="btn btn-success">Ajouter</button>
                        ...
                        <div class="module">
                            ...
                            <div class="module-body"><?php liste_campagnes();?>
                        </div></div>
...
$('input[type=radio][name=group]').change(
function ()
{ 
    var group=document.getElementsByName("group");
    for(var i=0;i<group.length;i++)
    {
         if(group[i].checked){var selectedGroup=group[i].value;}
    }
});
  </script>
