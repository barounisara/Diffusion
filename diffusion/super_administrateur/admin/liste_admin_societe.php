...
function liste_utilisateurs()
{
		...
		$societe=$row['societe'];
		$query="SELECT login,email,societe from `admin` WHERE societe='$societe'";
		$select=$conn->query($query);
		$i=0;
            ...
            <div class="row">
                <div class="span3">
                    <div class="sidebar">
                        ...
                        <!--/.widget-nav-->
                        <ul class="widget widget-menu unstyled">
                                <li><a href="../files/index.php"><i class="menu-icon icon-bold"></i> Bibliotheque </a></li>
                        ...
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
                                ...
                                <div class="btn-group pull-right" data-toggle="buttons-radio">
                                    <button type="button" onclick="ajouter_superAdmin()" class="btn btn-large btn-primary">
                                        <i class="icon-user"></i>Cr&eacute;er un administrateurr</button>
                                </div><br><br>
